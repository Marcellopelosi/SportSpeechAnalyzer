...
def main():
    ...
    if uploaded_file is not None:
        ...
        text_corrected = puntuaction_corrector.puntuaction_corrector(text)
        ...
        processed_dataframe = keywords_extractor.keywords_extractor(text_corrected)
